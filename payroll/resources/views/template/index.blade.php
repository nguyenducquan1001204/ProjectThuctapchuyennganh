                        ...
                        <table class="table star-student table-hover table-center table-borderless table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end"><div>2019</div></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end"><div>2018</div></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end"><div>2017</div></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-end"><div>2016</div></td>
                                </tr>
                                <tr>
                                    <td class="text-nowrap"><div>PRE2209</div></td>
                                    <td class="text-nowrap">
                                    ...
                                    <td class="text-center">1185</td>
                                    <td class="text-center">98%</td>
                                    <td class="text-end"><div>2015</div></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-body">
                    <div class="activity-groups">
                        ...
                        <div class="activity-awards">
                            ...
                            <div class="award-list-outs">
                                <h4>International conference in "St.John School"</h4>
                                <h5>Justin Lee attended international conference in "St.John School"</h5>
                            </div>
                            <div class="award-time-list">
