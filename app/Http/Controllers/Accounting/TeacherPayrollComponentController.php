...
class TeacherPayrollComponentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('accounting.teacherpayrollcomponents.index', compact('configs', 'allTeachers', 'allComponents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($errors)) {
            return redirect()->route('accounting.teacherpayrollcomponent.index')
