...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('accounting.payrollcomponentunitconfig.index') }}">
        <div class="row">
...
<div class="modal fade payrollcomponentunitconfig-modal" id="createPayrollComponentUnitConfigModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('accounting.payrollcomponentunitconfig.store') }}" method="post" id="createPayrollComponentUnitConfigForm">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-payrollcomponentunitconfig-btn')) {
                ...
                form.action = '{{ route("accounting.payrollcomponentunitconfig.update", ":id") }}'.replace(':id', configId);
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.delete-payrollcomponentunitconfig-btn')) {
                ...
                form.action = '{{ route("accounting.payrollcomponentunitconfig.destroy", ":id") }}'.replace(':id', configId);
