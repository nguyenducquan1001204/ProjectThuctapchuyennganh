...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('accounting.employmentcontract.index') }}">
        <div class="row">
...
<div class="modal fade contract-modal" id="createContractModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('accounting.employmentcontract.store') }}" method="post" id="createContractForm">
                @csrf
...
<script>
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.edit-contract-btn')) {
            ...
            form.action = '{{ route("accounting.employmentcontract.update", ":id") }}'.replace(':id', contractId);
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-contract-btn')) {
            ...
            form.action = '{{ route("accounting.employmentcontract.destroy", ":id") }}'.replace(':id', contractId);
