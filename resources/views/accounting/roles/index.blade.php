...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('accounting.role.index') }}">
        <div class="row">
...
<div class="modal fade role-modal" id="createRoleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('accounting.role.store') }}" method="post" id="createRoleForm">
                @csrf
    ...
    $(document).ready(function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.edit-role-btn')) {
                ...
                form.action = '{{ route("accounting.role.update", ":id") }}'.replace(':id', roleId);
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-role-btn')) {
                ...
                form.action = '{{ route("accounting.role.destroy", ":id") }}'.replace(':id', roleId);
