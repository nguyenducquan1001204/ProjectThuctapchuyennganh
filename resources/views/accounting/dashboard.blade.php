...
<div class="page-content">
    ...
    <div class="welcome-section">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h2 class="welcome-title">Chào mừng trở lại, Kế toán!</h2>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card table-card">
                <div class="table-header">
                    ...
                    <a href="{{ route('accounting.payrollrun.index') }}" class="btn btn-sm btn-primary btn-view-all">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card table-card">
                <div class="table-header">
                    ...
                    <a href="{{ route('accounting.teacher.index') }}" class="btn btn-sm btn-primary btn-view-all">
                        Xem tất cả <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
                <div class="table-body">
