...
@if (session('success'))
    <div class="modal fade systemuser-modal modal-success" id="successNotificationModal" tabindex="-1" aria-hidden="true">
...
@if ($errors->any())
    <div class="modal fade systemuser-modal modal-error" id="errorNotificationModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-white">
