...
@section('title', 'Quản lý menu giáo viên')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-sub-header">
                <h3 class="page-title">Quản lý menu giáo viên</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Trang chủ</a></li>
                    <li class="breadcrumb-item active">Quản lý menu giáo viên</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.teachermenuitem.index') }}">
        <div class="row">
            ...
            <div class="card-body">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Danh sách menu giáo viên</h3>
                        </div>
...
<div class="modal fade menuitem-modal" id="createMenuItemModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">Thêm menu giáo viên mới</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.teachermenuitem.store') }}" method="post" id="createMenuItemForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="routeName" class="form-control" placeholder="teacher.dashboard" value="{{ old('routeName') }}">
                        <small class="text-muted">Ví dụ: teacher.dashboard</small>
                        @error('routeName')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
...
<div class="modal fade menuitem-modal" id="view_menuitem" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">Chi tiết menu giáo viên</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
...
<div class="modal fade menuitem-modal" id="edit_menuitem" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">Chỉnh sửa menu giáo viên</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editMenuItemForm" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Tên route</label>
                        <input type="text" name="routeName" id="edit_item_routename" class="form-control" placeholder="teacher.dashboard">
                        <small class="text-muted">Ví dụ: teacher.dashboard</small>
                        @error('routeName')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
...
<div class="modal fade menuitem-modal modal-delete" id="delete_menuitem" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title">Xóa menu giáo viên</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    $(document).ready(function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.edit-menuitem-btn')) {
                ...
                form.action = '{{ route("admin.teachermenuitem.update", ":id") }}'.replace(':id', itemId);
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-menuitem-btn')) {
                ...
                form.action = '{{ route("admin.teachermenuitem.destroy", ":id") }}'.replace(':id', itemId);
