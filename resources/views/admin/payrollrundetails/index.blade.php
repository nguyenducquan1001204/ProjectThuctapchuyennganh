...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.payrollrundetail.index') }}">
        <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        function loadCalculationDetails(detailId) {
            ...
            fetch('{{ route("admin.payrollrundetail.getCalculationDetails", ":id") }}'.replace(':id', detailId))
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-payrollrundetail-btn')) {
                ...
                form.action = '{{ route("admin.payrollrundetail.destroy", ":id") }}'.replace(':id', detailId);
