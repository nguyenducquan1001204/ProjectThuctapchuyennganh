...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.basesalary.index') }}">
        <div class="row">
...
<div class="modal fade basesalary-modal" id="createBaseSalaryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.basesalary.store') }}" method="post" id="createBaseSalaryForm">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-basesalary-btn')) {
                ...
                form.action = '{{ route("admin.basesalary.update", ":id") }}'.replace(':id', basesalaryId);
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.terminate-basesalary-btn')) {
                ...
                form.action = '{{ route("admin.basesalary.terminate", ":id") }}'.replace(':id', basesalaryId);
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.delete-basesalary-btn')) {
                ...
                form.action = '{{ route("admin.basesalary.destroy", ":id") }}'.replace(':id', basesalaryId);
