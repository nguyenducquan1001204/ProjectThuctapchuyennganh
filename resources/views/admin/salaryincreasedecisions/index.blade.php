...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.salaryincreasedecision.index') }}">
        <div class="row">
...
<div class="modal fade salaryincreasedecision-modal" id="createSalaryIncreaseDecisionModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.salaryincreasedecision.store') }}" method="post" id="createSalaryIncreaseDecisionForm">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-salaryincreasedecision-btn')) {
                ...
                if (form) {
                    form.action = '{{ route("admin.salaryincreasedecision.update", ":id") }}'.replace(':id', decisionId);
                }
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.delete-salaryincreasedecision-btn')) {
                ...
                form.action = '{{ route("admin.salaryincreasedecision.destroy", ":id") }}'.replace(':id', decisionId);
