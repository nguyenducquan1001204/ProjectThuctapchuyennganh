...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.teacherpayrollcomponent.index') }}">
        <div class="row">
...
<div class="modal fade teacherpayrollcomponent-modal" id="createTeacherPayrollComponentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.teacherpayrollcomponent.store') }}" method="post" id="createTeacherPayrollComponentForm">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-teacherpayrollcomponent-btn')) {
                ...
                if (form) {
                    form.action = '{{ route("admin.teacherpayrollcomponent.update", ":id") }}'.replace(':id', configId);
                }
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.delete-teacherpayrollcomponent-btn')) {
                ...
                form.action = '{{ route("admin.teacherpayrollcomponent.destroy", ":id") }}'.replace(':id', configId);
