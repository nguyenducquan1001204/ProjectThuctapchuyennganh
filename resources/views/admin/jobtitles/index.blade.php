...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.jobtitle.index') }}">
        <div class="row">
...
<div class="modal fade jobtitle-modal" id="createJobTitleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.jobtitle.store') }}" method="post" id="createJobTitleForm">
                @csrf
    ...
    $(document).ready(function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.edit-jobtitle-btn')) {
                ...
                form.action = '{{ route("admin.jobtitle.update", ":id") }}'.replace(':id', jobtitleId);
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-jobtitle-btn')) {
                ...
                form.action = '{{ route("admin.jobtitle.destroy", ":id") }}'.replace(':id', jobtitleId);
