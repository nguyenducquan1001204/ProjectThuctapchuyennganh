...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.payrollcomponentconfig.index') }}">
        <div class="row">
...
<div class="modal fade payrollcomponentconfig-modal" id="createPayrollComponentConfigModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.payrollcomponentconfig.store') }}" method="post" id="createPayrollComponentConfigForm">
                @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-payrollcomponentconfig-btn')) {
                ...
                form.action = '{{ route("admin.payrollcomponentconfig.update", ":id") }}'.replace(':id', configId);
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.delete-payrollcomponentconfig-btn')) {
                ...
                form.action = '{{ route("admin.payrollcomponentconfig.destroy", ":id") }}'.replace(':id', configId);
