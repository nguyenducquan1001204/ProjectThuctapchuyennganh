...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('admin.payrollrundetailcomponent.index') }}">
        <div class="row">
...
<div class="modal fade payrollrundetailcomponent-modal" id="createPayrollRunDetailComponentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.payrollrundetailcomponent.store') }}" method="post" id="createPayrollRunDetailComponentForm">
                @csrf
    ...
    $(document).ready(function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.edit-payrollrundetailcomponent-btn')) {
                ...
                form.action = '{{ route("admin.payrollrundetailcomponent.update", ":id") }}'.replace(':id', detailComponentId);
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-payrollrundetailcomponent-btn')) {
                ...
                form.action = '{{ route("admin.payrollrundetailcomponent.destroy", ":id") }}'.replace(':id', detailComponentId);
