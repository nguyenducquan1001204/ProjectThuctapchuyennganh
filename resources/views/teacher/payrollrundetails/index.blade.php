    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-sub-header">
                <h3 class="page-title">Bảng lương chi tiết của tôi</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('teacher.dashboard') }}">Trang chủ</a></li>
                    <li class="breadcrumb-item active">Bảng lương chi tiết của tôi</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="student-group-form mb-4">
    <form method="GET" action="{{ route('teacher.payrollrundetail.index') }}">
        <div class="row">
            ...
            <div class="card-body">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Danh sách bảng lương chi tiết của tôi</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped payrollrundetail-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center text-muted">Chưa có dữ liệu bảng lương chi tiết.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function() {
        ...
        function loadCalculationDetails(detailId) {
            ...
            fetch('{{ route("teacher.payrollrundetail.getCalculationDetails", ":id") }}'.replace(':id', detailId))
